...
internal fun mockNowForTimeClasses(value: ZonedDateTime) {
  ClassesExtendTemporal.forEach { klass, toSpecificTimeClass ->
    ...
    mockkNowFunctionWithParameterZoneId(klass, toSpecificTimeClass, value)
  }
}

@PublishedApi
internal fun mockkNowFunctionWithParameterZoneId(klass: KClass<out Any>, toSpecificTimeClass: KFunction1<ZonedDateTime, Any>, value: ZonedDateTime) {
