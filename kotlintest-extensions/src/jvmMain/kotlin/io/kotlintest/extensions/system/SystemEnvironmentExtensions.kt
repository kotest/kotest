...
import io.kotlintest.extensions.system.OverrideMode.SetOrError
...
abstract class SystemEnvironmentListener(private val environment: Map<String, String>, private val mode: OverrideMode) : TestListener {
 ...
 * already changed, the result is inconsistent, as the System Environment Map is a single map.
 */
class SystemEnvironmentTestListener(environment: Map<String, String>, mode: OverrideMode = SetOrError) : SystemEnvironmentListener(environment, mode) {
 ...
 * already changed, the result is inconsistent, as the System Environment Map is a single map.
 */
class SystemEnvironmentProjectListener(environment: Map<String, String>, mode: OverrideMode = SetOrError) : SystemEnvironmentListener(environment, mode) {
