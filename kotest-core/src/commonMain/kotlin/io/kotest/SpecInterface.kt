...
/**
 * A [SpecInterface] is the top level component in Kotest.
 *
 ...
 *
 * A [SpecInterface] is also a [TestListener] to allow for
 * convenience overloads here if you just want to listen
 * in a single place.
 */
@Deprecated("To be replaced and this will be merged into abstract spec")
interface SpecInterface : TestListener {
    ...
    * in this [SpecInterface] in addition to any defined on the individual
    * tests themselves.
    */
 ...
 */
fun SpecInterface.focused(): List<TestCase> = testCases().filter { it.name.startsWith("f:") }
