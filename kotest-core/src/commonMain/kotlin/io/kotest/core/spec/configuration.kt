...
abstract class TestConfiguration {
    ...
    * and not other tests in a [SpecConfiguration].
    */
    ...
    * for tests generated by this factory and not other tests in a [SpecConfiguration].
    */
    ...
    * this [TestFactoryConfiguration]. When this factory is included in a [SpecConfiguration], only the tests generated
...
abstract class SpecConfiguration : TestConfiguration(), CompatibilitySpecConfiguration {
   ...
   /**
    * Adds a new root-level [TestCase] to this [SpecConfiguration].
    */
