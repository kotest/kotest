 ...
 * instance of this class will be applied to all [SpecInterface] and [TestCase]s.
 *
...
abstract class AbstractProjectConfig {
    ...
    * The value set here will be used unless overriden in a [SpecInterface].
    * The value in a [SpecInterface] is always taken in preference to the value here.
    ...
    * If a [SpecInterface] sets an assertion mode, then the spec will override.
    */
