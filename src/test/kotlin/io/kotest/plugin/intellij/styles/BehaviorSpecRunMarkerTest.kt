...
class BehaviorSpecRunMarkerTest : LightJavaCodeInsightFixtureTestCase() {
   ...
   fun testGutterIcons() {
      ...
      val expected = listOf(
         ...
         Gutter("Disabled - a given disabled when this then should be disabled from its parent", 407, AllIcons.RunConfigurations.TestIgnored),
         ...
         Gutter("Disabled - a given an and disabled when this then should be disabled by nesting", 860, AllIcons.RunConfigurations.TestIgnored),
         Gutter("Disabled - a given an and disabled when an xdisabled then", 943, AllIcons.RunConfigurations.TestIgnored),
         ...
         Gutter("Disabled - disabled given disabled when a disabled then", 1243, AllIcons.RunConfigurations.TestIgnored),
