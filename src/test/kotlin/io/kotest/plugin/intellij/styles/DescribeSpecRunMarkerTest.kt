...
class DescribeSpecRunMarkerTest : LightJavaCodeInsightFixtureTestCase() {
   ...
   fun testGutterIcons() {
      ...
      val expected = listOf(
         ...
         Gutter("Disabled - describe block nested xdescribe block it block", 688, AllIcons.RunConfigurations.TestIgnored),
         ...
         Gutter("Disabled - xdescribe block nested describe block it block", 1178, AllIcons.RunConfigurations.TestIgnored),
         Gutter("Disabled - xdescribe block nested xdescribe block", 1264, AllIcons.RunConfigurations.TestIgnored),
         Gutter("Disabled - xdescribe block nested xdescribe block it block", 1307, AllIcons.RunConfigurations.TestIgnored),
         ...
         Gutter("Disabled - context block nested context block nested xdescribe block", 1622, AllIcons.RunConfigurations.TestIgnored),
         Gutter("Disabled - context block nested context block nested xdescribe block it block", 1668, AllIcons.RunConfigurations.TestIgnored),
         Gutter("Disabled - context block nested xcontext block", 1773, AllIcons.RunConfigurations.TestIgnored),
         Gutter("Disabled - context block nested xcontext block nested describe block", 1821, AllIcons.RunConfigurations.TestIgnored),
         Gutter("Disabled - context block nested xcontext block nested describe block it block", 1866, AllIcons.RunConfigurations.TestIgnored),
         Gutter("Disabled - context block nested xcontext block nested xdescribe block", 1964, AllIcons.RunConfigurations.TestIgnored),
         Gutter("Disabled - context block nested xcontext block nested xdescribe block it block", 2010, AllIcons.RunConfigurations.TestIgnored),
