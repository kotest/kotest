...
class ShouldSpecStyleTest : LightCodeInsightFixtureTestCase() {
   ...
   fun testGutterIcons() {
      ...
      assertSoftly {
         ...
         gutters[7].tooltipText shouldBe "Run some context 2"
         ...
         gutters[8].tooltipText shouldBe "Run some context 2 -- some nested context should top level test"
         ...
         gutters[9].tooltipText shouldBe "Run some context 2 -- some nested context should top level test with config"
