...
class WordSpecStyleTest : LightCodeInsightFixtureTestCase() {
   ...
   fun testGutterIcons() {
      ...
      assertSoftly {
         ...
         gutters[3].tooltipText shouldBe "[Kotest] some should context should test something with config"
         ...
         gutters[7].tooltipText shouldBe "[Kotest] with capital When when and capital Should should test something with config"
