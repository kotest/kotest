...
class OffsetsTest : LightCodeInsightFixtureTestCase() {
   ...
   fun testLineOffsets() {
      ...
      offsets.first shouldBe 511
      offsets.last shouldBe 544
   }
   ...
   fun testFindElementForAGivenLine() {
      ...
      element.startOffset shouldBe 550
      element.endOffset shouldBe 556
   }
}
