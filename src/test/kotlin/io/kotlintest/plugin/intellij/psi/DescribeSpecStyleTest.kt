...
class DescribeSpecStyleTest : LightCodeInsightFixtureTestCase() {
  ...
  fun testGutterIcons() {
    ...
    gutters[1].tooltipText shouldBe "[KotlinTest] some thing"
    (gutters[1] as LineMarkerInfo.LineMarkerGutterIconRenderer<*>).lineMarkerInfo.startOffset shouldBe 158

    gutters[2].icon shouldBe AllIcons.RunConfigurations.TestState.Run
    gutters[2].tooltipText shouldBe "[KotlinTest] some thing -- test name"
    ...
    gutters[3].tooltipText shouldBe "[KotlinTest] some thing -- with some context"
    ...
    gutters[4].tooltipText shouldBe "[KotlinTest] some thing -- with some context -- test name"
    ...
    gutters[5].tooltipText shouldBe "[KotlinTest] some thing -- with some context -- test name 2"
    ...
    gutters[6].tooltipText shouldBe "[KotlinTest] some thing -- with some context -- yet another context"
    ...
    gutters[7].tooltipText shouldBe "[KotlinTest] some thing -- with some context -- yet another context -- test name"
    ...
    gutters[8].tooltipText shouldBe "[KotlinTest] some thing -- with some context -- yet another context -- test name 2"
