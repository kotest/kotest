    ...
    "JUnit XML Output" should {
      ...
      val file = when {
        System.getenv("TRAVIS") == "true" -> {
          println(File(System.getenv("TRAVIS_BUILD_DIR") + "/kotlintest-tests/kotlintest-tests-core/build/test-results").listFiles().joinToString("\n"))
        ...
        System.getenv("APPVEYOR") == "True" -> {
          println(File(System.getenv("APPVEYOR_BUILD_FOLDER") + "/kotlintest-tests/kotlintest-tests-core/build/test-results").listFiles().joinToString("\n"))
