...
| `collection.shouldContainExactly()`             | Assert that a collection contains exactly the given values and nothing else, in the order given.                                                                  |
...
| `collection.shouldContainAllInAnyOrder()`       | Assert that a collection contains at least all the given values, and optionally more, in _any_ order.                                                             |
