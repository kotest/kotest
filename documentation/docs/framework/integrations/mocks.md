...
Kotest itself has no mock features, except for [fakery](https://kotest.io/docs/framework/fake_functions.md) which allows to build test doubles. However, you can plug-in your favourite mocking library with ease!
