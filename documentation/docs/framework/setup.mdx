...
:::info[Install the IntelliJ Plugin]
Kotest provides an IntelliJ plugin for enhanced UX, including the ability to run individual tests, tool windows to show
test layouts, and jump to source.
:::
...
For enhanced support for jump-to-source and re-running failed tests from the test results tree,
