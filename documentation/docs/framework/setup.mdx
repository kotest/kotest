...
Kotest on the JVM builds on the [JUnit Platform](https://junit.org/junit5/docs/current/user-guide/#running-tests-build-gradle) gradle plugin which is ubiquitous in the JVM ecosystem.

To use the JUnit Platform support, first configure Gradle:
