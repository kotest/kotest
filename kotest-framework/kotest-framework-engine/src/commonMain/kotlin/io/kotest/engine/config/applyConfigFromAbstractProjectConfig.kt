...
/**
 * Applies settings from a [AbstractProjectConfig] instance to the given [MutableConfiguration].
 */
internal fun applyConfigFromProjectConfig(config: AbstractProjectConfig, configuration: MutableConfiguration) {
