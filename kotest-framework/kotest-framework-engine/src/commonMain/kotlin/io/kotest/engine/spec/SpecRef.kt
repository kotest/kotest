...
data class FunctionSpecRef(val fn: () -> Spec, override val kclass: KClass<out Spec>) : SpecRef {
   override suspend fun instance(registry: ExtensionRegistry): Result<Spec> = Result.success(fn())
}
...
internal expect suspend fun instantiate(kclass: KClass<out Spec>, registry: ExtensionRegistry): Result<Spec>
