 ...
 */
internal suspend fun AssertionMode.executeWithAssertionsCheck(name: TestName, run: suspend () -> Unit) {
   assertionCounter.reset()
   run()
   val warningMessage = "Test '${name.testName}' did not invoke any assertions"
