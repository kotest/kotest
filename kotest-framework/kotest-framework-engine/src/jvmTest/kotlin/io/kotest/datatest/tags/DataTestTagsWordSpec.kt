...
class DataTestTagsWordSpec : WordSpec({
   ...
   "parent context" When {
      ...
      withWhens("firstChildOfParentContext1", "firstChildOfParentContext2") { // line 30 -> kotest.data.30
         1 + 1 shouldBe 2
      }
   }
   ...
   withData("parent1", "parent2", "parent3") { // line 36 -> kotest.data.36
      withWhens("firstChild1", "firstChild2") { // line 37 -> kotest.data.37
         1 + 1 shouldBe 2
      }
      withWhens("secondChild1", "secondChild2") { // line 40 -> kotest.data.40
         withWhens("firstChildOfSecondChild1", "firstChildOfSecondChild2") { // line 41 -> kotest.data.41
            ...
            withShoulds("secondChildOfFirstChildOfSecondChild1", "secondChildOfFirstChildOfSecondChild2") { // line 45 -> kotest.data.45
               1 + 1 shouldBe 2
            }
         }
