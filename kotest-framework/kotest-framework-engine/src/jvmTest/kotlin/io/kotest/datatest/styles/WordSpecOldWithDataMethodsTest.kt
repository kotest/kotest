...
class WordSpecOldWithDataMethodsTest : WordSpec() {
   init {
      ...
      withData(
         ...
         "context $it" should {
            "test $it" {
               this.testCase.descriptor.path() shouldBe DescriptorPath("io.kotest.datatest.styles.WordSpecOldWithDataMethodsTest/$it -- context $it -- test $it")
            }
         }
      }
      ...
      "inside a context" `when` {
         ...
         withData(
            ...
            "context $it" should {
               "test $it" {
                  this.testCase.descriptor.path() shouldBe DescriptorPath("io.kotest.datatest.styles.WordSpecOldWithDataMethodsTest/inside a context -- $it -- context $it -- test $it")
               }
            }
         }
      }
