 ...
 * has type [TestType.Test]) in a fresh instance of the [SpecInterface] class (that is, isolated
 ...
 */
class InstancePerLeafSpecRunner(
...
//    rootTests.tests.forEach { test -> enqueue(test.testCase) }
