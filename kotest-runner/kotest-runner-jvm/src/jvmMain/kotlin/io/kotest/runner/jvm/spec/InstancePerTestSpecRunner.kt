 ...
 * spec3.innerTestB
 */
class InstancePerTestSpecRunner(
...
//   */
//  override fun execute(spec: SpecInterface, rootTests: RootTests): Map<TestCase, TestResult> {
//    rootTests.tests.forEach { enqueue(it.testCase, true) }
...
//   * of the containing [SpecInterface] class. Therefore, when we begin executing a test case from
