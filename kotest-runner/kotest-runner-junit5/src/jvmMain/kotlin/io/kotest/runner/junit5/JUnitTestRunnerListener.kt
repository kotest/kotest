...
class JUnitTestRunnerListener(
   ...
   override fun beforeSpecClass(klass: KClass<out SpecConfiguration>) {
      ...
      try {
         ...
         logger.trace("Notifying junit that execution has started for $descriptor")
         listener.executionStarted(descriptor)
     //    listener.executionFinished(descriptor, TestExecutionResult.successful())
         logger.trace("qweqwewe $descriptor")
      } catch (t: Throwable) {
   ...
   private fun createTestCaseDescriptor(description: Description, type: TestType): TestDescriptor {
      ...
      val parent = descriptors[parentDescription]
         ?: throw RuntimeException("Could not find $parentDescription in the list of descriptors")
