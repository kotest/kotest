 ...
 */
class SpecAwareTestFilter(testPath: String, spec: KClass<out SpecInterface>) : TestCaseFilter {

  private fun KClass<out SpecInterface>.isSpec(classname: String): Boolean =
