...
inline fun <T> eventually(duration: Duration, f: () -> T): T = eventually(duration, Exception::class.java, f)

inline fun <T, E : Throwable> eventually(duration: Duration, exceptionClass: Class<E>, f: () -> T): T {
