...
fun <A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P, Q> forNone(
   ...
   val paramP = params.getOrElse(15) { "p" }
   val paramQ = params.getOrElse(16) { "q" }
   table(headers(paramA, paramB, paramC, paramD, paramE, paramF, paramG, paramH, paramI, paramJ, paramK, paramL, paramM, paramN, paramO, paramP, paramQ), *rows).forNone(testfn)
}
