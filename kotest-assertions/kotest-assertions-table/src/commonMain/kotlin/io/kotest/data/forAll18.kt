...
suspend fun <A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P, Q, R> forAll(
   ...
   table(
      headers(paramA, paramB, paramC, paramD, paramE, paramF, paramG, paramH, paramI, paramJ, paramK, paramL, paramM, paramN, paramO, paramP, paramQ, paramR),
      *rows
   ).forAll { A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P, Q, R ->
      testfn(A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P, Q, R)
   }
}
...
suspend fun <A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P, Q, R> forNone(
   ...
   table(
      headers(paramA, paramB, paramC, paramD, paramE, paramF, paramG, paramH, paramI, paramJ, paramK, paramL, paramM, paramN, paramO, paramP, paramQ, paramR),
      *rows
   ).forNone { A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P, Q, R ->
      testfn(A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P, Q, R)
   }
}
