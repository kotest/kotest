...
internal fun<T> printMatch(leftList: List<T>, match: MatchResultsOfSubLists): String{
    return with(StringBuilder("\nMatch:\n")) {
...
internal fun<T> printMismatch(leftList: List<T>, rightList: List<T>, match: MatchResultsOfSubLists): String{
    return with(StringBuilder("\nMismatch:\n")) {
...
internal fun Iterable<String>.joinNotEmptyToString(separator: CharSequence): String {
