...
class RangePrintTest : FunSpec() {
   init {
      test("IntRangePrint should print the string presentation") {
         IntRangePrint.print((Int.MIN_VALUE until 1), 0) shouldBe Printed("-2147483648..0", IntRange::class)
      }
      test("LongRangePrint should print the string presentation") {
         LongRangePrint.print(1L until 10L, 0) shouldBe Printed("1..9", LongRange::class)
      }
      test("UIntRange should print the string presentation") {
         UIntRangePrint.print((1.toUInt()..6.toUInt()), 0) shouldBe Printed("1..6", UIntRange::class)
      }
      test("ULongRangePrint should print the string presentation") {
         ULongRangePrint.print(1L.toULong() until 10L.toULong(), 0) shouldBe Printed("1..9", ULongRange::class)
      }
      test("CharRangePrint should print the string presentation") {
         CharRangePrint.print('a'..'z', 0) shouldBe Printed("a..z", CharRange::class)
      }
