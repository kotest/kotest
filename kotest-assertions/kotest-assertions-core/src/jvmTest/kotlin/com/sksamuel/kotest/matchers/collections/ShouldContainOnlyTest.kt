    ...
    init {
        "containOnly" should {
            "test that an array contains given elements only" {
                ...
                }.shouldHaveMessage("Some elements were unexpected: [1]")

                shouldThrow<AssertionError> {
                    actual shouldContainOnly arrayOf(3, 2, 4, 3)
                }.shouldHaveMessage("Some elements were missing: [4] and some elements were unexpected: [1]")

                shouldThrow<AssertionError> {
                    actual shouldContainOnly arrayOf(1, 3, 2, 4, 1)
                }.shouldHaveMessage("Some elements were missing: [4]")
            ...
            "test that an array contains not just the given elements" {
                ...
                }.shouldHaveMessage("Collection should not have just [1, 2, 3]")
