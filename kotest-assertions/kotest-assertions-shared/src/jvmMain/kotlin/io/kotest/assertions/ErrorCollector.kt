...
object ThreadLocalErrorCollector : ErrorCollector {
   ...
   private val clueContext = object : ThreadLocal<Stack<() -> String>>() {
      override fun initialValue(): Stack<() -> String> = Stack()
   }
   ...
   override fun clueContext(): List<() -> String> = clueContext.get()
