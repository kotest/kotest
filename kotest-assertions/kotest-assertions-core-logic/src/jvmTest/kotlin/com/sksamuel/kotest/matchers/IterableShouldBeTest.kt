   ...
   init {
      describe("shouldBe") {
         ...
         it("array / java.util.ArrayList") {
            arrayOf(1, 2, 3) shouldBe ArrayList(listOf(1, 2, 3))
            arrayOf(1, 2, 3) shouldNotBe ArrayList(listOf(5, 6, 7))
            arrayOf<Int>() shouldBe ArrayList<Int>()
            arrayOf(1) shouldNotBe ArrayList<Int>()
            arrayOf(1) shouldNotBe ArrayList<Int>()
            emptyArray<Int>() shouldNotBe ArrayList(listOf(1))
         }
      }
   }
}
