...
class SettingsEditorPanel(project: Project) : SettingsEditor<KotlinTestRunConfiguration>() {
  ...
  override fun resetEditorFrom(configuration: KotlinTestRunConfiguration) {
