...
//      val listener = JUnitTestEngineListener(mock, rootDescriptor)
//
//      val spec = JUnitTestRunnerListenerTest()
//      listener.beforeSpecClass(spec::class)
//      listener.specCompleted(spec::class, null)
//
...
//
//      listener.specCompleted(spec1::class, null)
//      listener.specCompleted(spec2::class, null)
//
