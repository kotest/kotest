...
class InlineTimeoutSuccessPrecedenceTest : FunSpec() {
   init {
      timeout = 1
      test("test case config timeout should take precedence").config(timeout = Duration.milliseconds(1000)) {
         // this test should pass because the test overrides the timeout to 1000
