...
suspend fun <A, B, C, D, E, F, G, H, I, J, K, L> checkAll(
   ...
   genL: Gen<L>,
   property: suspend PropertyContext.(A, B, C, D, E, F, G, H, I, J, K, L) -> Unit
): PropertyContext = proptest(genA, genB, genC, genD, genE, genF, genG, genH, genI, genJ, genK, genL, config.copy(constraints = Constraints.iterations(iterations)), property)
