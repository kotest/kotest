 ...
 */
fun Arb.Companion.float(min: Float = -Float.MAX_VALUE, max: Float = Float.MAX_VALUE, includeNonFiniteEdgeCases: Boolean = false): Arb<Float> = float(min..max, includeNonFiniteEdgeCases)
