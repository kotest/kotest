 ...
 *
 * The edge cases are 0 and 1, since these are multiples of every integer.
 *
...
fun Arb.Companion.multiples(k: Int, max: Int): Arb<Int> =
   arbitrary(listOf(0, 1), MultiplesShrinker(k)) { it.random.nextInt(0, max / k) * k }
