...
@Deprecated("use positiveInt. Deprecated in 5.0 and will be removed in 6.0", ReplaceWith("positiveInt(max)"))
...
@Deprecated("use negativeInt. Deprecated in 5.0 and will be removed in 6.0", ReplaceWith("negativeInt(min)"))
