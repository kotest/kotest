...
fun Arb.Companion.ints(range: IntRange = Int.MIN_VALUE..Int.MAX_VALUE) =
 ...
 */
fun Arb.Companion.nats(max: Int = Int.MAX_VALUE) = ints(1..max)

/**
 * Returns an [Arb] where each value is a randomly chosen negative integer.
 * The edge cases are: [Int.MIN_VALUE]
 */
fun Arb.Companion.negativeInts(min: Int = Int.MIN_VALUE) = ints(min..0)

/**
 * Returns an [Arb] where each value is a randomly chosen positive integer.
 * The edge cases are: [Int.MAX_VALUE]
 */
fun Arb.Companion.positiveInts(max: Int = Int.MAX_VALUE) = ints(0..Int.MAX_VALUE)
