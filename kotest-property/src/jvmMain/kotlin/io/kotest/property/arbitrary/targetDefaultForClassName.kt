...
fun targetDefaultForType(
   ...
   when (type) {
      ...
      typeOf<ByteArray>(), typeOf<ByteArray?>() -> Arb.byteArray(Arb.int(10..15), Arb.byte())
      typeOf<ShortArray>(), typeOf<ShortArray?>() -> Arb.shortArray(Arb.int(10..15), Arb.short())
      typeOf<IntArray>(), typeOf<IntArray?>() -> Arb.intArray(Arb.int(10..15), Arb.int())
      typeOf<LongArray>(), typeOf<LongArray?>() -> Arb.longArray(Arb.int(10..15), Arb.long())
      typeOf<FloatArray>(), typeOf<FloatArray?>() -> Arb.floatArray(Arb.int(10..15), Arb.float())
      typeOf<DoubleArray>(), typeOf<DoubleArray?>() -> Arb.doubleArray(Arb.int(10..15), Arb.double())
      typeOf<BooleanArray>(), typeOf<BooleanArray?>() -> Arb.booleanArray(Arb.int(10..15), Arb.boolean())
      typeOf<CharArray>(), typeOf<CharArray?>() -> Arb.charArray(Arb.int(10..15), Arb.char())
      else -> null
   }?.let { return it }
