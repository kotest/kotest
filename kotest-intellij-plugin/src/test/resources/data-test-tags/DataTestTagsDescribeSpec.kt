...
class DataTestTagsDescribeSpec : DescribeSpec({
   ...
   withData("parent1", "parent2", "parent3") { // tag: "(kotest.data.36) | kotest.data.nonJvm"
      withContexts("firstChild1", "firstChild2") { // tag: "(kotest.data.36 & !kotest.data.40 & !kotest.data.58) | kotest.data.nonJvm"
         1 + 1 shouldBe 2
      }
      withContexts("secondChild1", "secondChild2") { // tag: "(kotest.data.36 & !kotest.data.37 & !kotest.data.58) | kotest.data.nonJvm"
         withDescribes("firstChildOfSecondChild1", "firstChildOfSecondChild2") { // tag: "(kotest.data.36 & !kotest.data.37 & !kotest.data.58 & !kotest.data.49 & !kotest.data.52) | kotest.data.nonJvm"
            withIts("firstChildOfFirstChildOfSecondChild1", "firstChildOfFirstChildOfSecondChild2") { // tags: "(kotest.data.36 & !kotest.data.37 & !kotest.data.58 & !kotest.data.49 & !kotest.data.52 & !kotest.data.45) | kotest.data.nonJvm"
               1 + 1 shouldBe 2
            }
            withIts("secondChildOfFirstChildOfSecondChild1", "secondChildOfFirstChildOfSecondChild2") { // tags: "(kotest.data.36 & !kotest.data.37 & !kotest.data.58 & !kotest.data.49 & !kotest.data.52 & !kotest.data.42) | kotest.data.nonJvm"
               1 + 1 shouldBe 2
            }
         }
         withContexts("secondChildOfSecondChild1", "secondChildOfSecondChild2") { // tags: "(kotest.data.36 & !kotest.data.37 & !kotest.data.58 & !kotest.data.41 & !kotest.data.52) | kotest.data.nonJvm"
            1 + 1 shouldBe 2
         }
         withData("thirdChildOfSecondChild1", "thirdChildOfSecondChild2") { // tags: "(kotest.data.36 & !kotest.data.37 & !kotest.data.58 & !kotest.data.41 & !kotest.data.49) | kotest.data.nonJvm"
            withContexts("firstAndOnlyChildOfThirdChildOfSecondChild1", "firstAndOnlyChildOfThirdChildOfSecondChild2") { // tags: "(kotest.data.36 & !kotest.data.37 & !kotest.data.58 & !kotest.data.41 & !kotest.data.49) | kotest.data.nonJvm" - same as parent as no siblings
               1 + 1 shouldBe 2
            }
         }
      }
