   ...
   fun testDataTestTagMaybeReturnsTagExpressionForNestedDataTests() {
      ...
      testFiles.forEach { testFile ->
         ...
         DataTestUtil.dataTestInfoMaybe(isDataTest = true, firstChildOfFirstChildOfChildContext).apply {
            this.shouldNotBeNull()
            tag shouldBe "(kotest.data.16 & !kotest.data.20) | !kotest.data"
            ancestorTestPath shouldBe "parent context -- child context"
         }
         ...
         DataTestUtil.dataTestInfoMaybe(isDataTest = true, secondChildOfFirstChildOfChildContext).apply {
            this.shouldNotBeNull()
            tag shouldBe "(kotest.data.16 & !kotest.data.17) | !kotest.data"
            ancestorTestPath shouldBe "parent context -- child context"
         }
         ...
         DataTestUtil.dataTestInfoMaybe(isDataTest = true, secondChildOfChildContext).apply {
            this.shouldNotBeNull()
            tag shouldBe "(kotest.data.26) | !kotest.data"
            ancestorTestPath shouldBe "parent context -- child context"
         }
         ...
         DataTestUtil.dataTestInfoMaybe(isDataTest = true, firstChildOfParentContext).apply {
            this.shouldNotBeNull()
            tag shouldBe "(kotest.data.30) | !kotest.data"
         ...
         DataTestUtil.dataTestInfoMaybe(isDataTest = true, rootWithData)?.tag shouldBe "kotest.data.36"
         ...
         DataTestUtil.dataTestInfoMaybe(
            isDataTest = true,
            firstChild
         )?.tag shouldBe "kotest.data.36 & !kotest.data.40 & !kotest.data.58"
         ...
         DataTestUtil.dataTestInfoMaybe(
            isDataTest = true,
            secondChild
         )?.tag shouldBe "kotest.data.36 & !kotest.data.37 & !kotest.data.58"
         ...
         )?.tag shouldBe "kotest.data.36 & !kotest.data.37 & !kotest.data.58 & !kotest.data.49 & !kotest.data.52"
         ...
         )?.tag shouldBe "kotest.data.36 & !kotest.data.37 & !kotest.data.58 & !kotest.data.49 & !kotest.data.52 & !kotest.data.45"
         ...
         )?.tag shouldBe "kotest.data.36 & !kotest.data.37 & !kotest.data.58 & !kotest.data.49 & !kotest.data.52 & !kotest.data.42"
         ...
         )?.tag shouldBe "kotest.data.36 & !kotest.data.37 & !kotest.data.58 & !kotest.data.41 & !kotest.data.52"
         ...
         )?.tag shouldBe "kotest.data.36 & !kotest.data.37 & !kotest.data.58 & !kotest.data.41 & !kotest.data.49"
         ...
         DataTestUtil.dataTestInfoMaybe(
            isDataTest = true,
            thirdChild
         )?.tag shouldBe "kotest.data.36 & !kotest.data.37 & !kotest.data.40"
      }
   }
