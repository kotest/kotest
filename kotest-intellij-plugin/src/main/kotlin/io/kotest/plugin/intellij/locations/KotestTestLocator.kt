 ...
 */
@Deprecated("Starting with Kotest 6.1 locations will be handled by the EmbeddedLocationTestLocator")
class KotestTestLocator : SMTestLocator, DumbAware {

   companion object {

      /**
       * This must match the value generated by the TCSM's from kotest engine
       */
      const val LOCATION_HINT_PROTOCOL = "kotest"
   }
   ...
   override fun getLocation(
      ...
      return when (protocol) {
         LOCATION_HINT_PROTOCOL -> parseClass(project, scope, path)
         else -> emptyList()
      }
   }
