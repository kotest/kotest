...
/**
 * Returns a matcher for an interval of this [Double] plus or minus [tolerance]
 *
 * Returns a matcher for an interval ranging between this [Double] minus [tolerance] and this [Double] plus [tolerance].
 *
 * ```
